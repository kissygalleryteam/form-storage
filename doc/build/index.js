...
kg/form-storage/2.0.0/storage
kg/form-storage/2.0.0/index

*/
KISSY.add('kg/form-storage/2.0.0/storage',function (S,RichBase,LocalStorage,JSON){
    var E = S.Event;
    var win = window;
    ...
    return new Storage();
},{requires : ['rich-base','kg/offline/1.1/index','json','node' , 'event']});
/**
 * 基于本地存储实现的表单临时保存功能，支持自动保存，用户自定义保存
 */
KISSY.add('kg/form-storage/2.0.0/index',function (S,RichBase , Ajax , Tmpl , Storage){
    var win = window;
    ...
    var FormStorage = RichBase.extend({
        ...
        renderUI : function (){
            ...
            this.controlNode = S.one('<div class="form-storage">' +
                ...
                '<button type="button" class="btn btn-xs btn-success J_AddStorage">临时保存</button><a href="https://github.com/Gourdboy/form-storage/blob/master/README.md" target="_blank">什么是临时保存?</a>' +
